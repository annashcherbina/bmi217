...
def createModel():
    ...
    # convolution layer with 300 filters of size 1x15
    model.add(Convolution2D(300,1,15,W_constraint=maxnorm(m=7)))
    # batch normalization as a regularizer to prevent overfitting
    model.add(BatchNormalization(mode=0, axis=1))
    # PReLU rectification activation
    model.add(PReLU())
    ...
    # convolution layer with 200 filters of size 1x7
