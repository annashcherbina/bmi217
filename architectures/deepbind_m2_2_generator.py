...
def createModel():
    ...
    # dropout included only as a template
    model.add(Dropout(0.0))    
    model.add(Flatten())
    # fully connected layer, and ReLU to prevent overfitting
    model.add(Dense(128, bias=True))
    model.add(Activation("relu"))
    # fully connected layer and a softmax activation
